...
class TailerListenerException extends RuntimeException {
     ...
     */
    public TailerListenerException(String message) {
        super(message);
    }
     ...
     * @since 1.6
     */
    public TailerListenerException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.6
     */
    public TailerListenerException(Throwable cause) {
        super(cause);
    }
}